         ...
         <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="contact-form">
               ...
               <form role="form" method="post" action="photosharing-home.php">

                 <div class="form-group">
    			<div class="login-wrapper">
                <span class="Form-text">Enter UserName:</span><input type="Name" class="form-control" name="userEmail" placeholder="Enter Your Email">
                <span class="Form-text">Enter  password:</span><input type="password" class="form-control"  name="passWord" placeholder="Enter Your Pass-Word">
