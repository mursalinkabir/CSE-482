...
<head>
  ...
  <body>
  	...
  	if($_SERVER['REQUEST_METHOD']=='POST')
  	{
			...
			$sqlQuery = "SELECT * FROM registered_user WHERE email='$userEmail'";
			...
			else
			{
				...
				//echo "Password Didn\'t Match!!!<br>Try Again for Login:<a href=\"photosharing-login.php\"><input type=\"button\" value=\"GoToLogin\"></a>";
